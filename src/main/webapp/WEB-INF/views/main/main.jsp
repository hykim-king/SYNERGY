...
<body>
	...
	<nav class="navbar">
		<ul class="navbar__menu">
			<!-- 전체 차량 모델도 드롭다운으로 -->
			<li class="navbar__item--dropdown"></li>
			...
			<li class="navbar__item--dropdown">
				...
				<ul class="dropdown__content">
					<li><a
						href="${pageContext.request.contextPath}/car/detail.do?carCode=1">현대</a></li>
					<li><a
						href="${pageContext.request.contextPath}/car/detail.do?carCode=2">기아</a></li>
					<li><a
						href="${pageContext.request.contextPath}/car/detail.do?carCode=3">포르쉐</a></li>
					<li><a
						href="${pageContext.request.contextPath}/car/detail.do?carCode=4">람보르기니</a></li>
					<li><a
						href="${pageContext.request.contextPath}/car/detail.do?carCode=5">BMW</a></li>
					<li><a
						href="${pageContext.request.contextPath}/car/detail.do?carCode=6">토요타</a></li>
					<li><a
						href="${pageContext.request.contextPath}/car/detail.do?carCode=7">벤츠</a></li>
					<li><a
						href="${pageContext.request.contextPath}/car/detail.do?carCode=8">테슬라</a></li>
					<li><a
						href="${pageContext.request.contextPath}/event/doRetrieve.do">페라리</a>
					</li>

					<li><a
						href="${pageContext.request.contextPath}/event/doRetrieve.do">포드</a>
					</li>
					<li><a
						href="${pageContext.request.contextPath}/event/doRetrieve.do">쉐보레</a>
					</li>
					<li><a
						href="${pageContext.request.contextPath}/event/doRetrieve.do">KGM</a>
					</li>

					<li><a
						href="${pageContext.request.contextPath}/event/doRetrieve.do">아우디</a>
					</li>
					<li><a
						href="${pageContext.request.contextPath}/event/doRetrieve.do">볼보</a>
					</li>
					<li><a
						href="${pageContext.request.contextPath}/event/doRetrieve.do">지프</a>
					</li>
					<li><a
						href="${pageContext.request.contextPath}/event/doRetrieve.do">혼다</a>
					</li>
					<li><a
						href="${pageContext.request.contextPath}/event/doRetrieve.do">미니</a>
					</li>
					<li><a
						href="${pageContext.request.contextPath}/event/doRetrieve.do">르노코리아
					</a></li>
					<li><a
						href="${pageContext.request.contextPath}/event/doRetrieve.do">렉서스</a>
					</li>
					<li><a
						href="${pageContext.request.contextPath}/event/doRetrieve.do">랜드로버
					</a></li>

					<li><a
						href="${pageContext.request.contextPath}/event/doRetrieve.do">폭스바겐
					</a></li>
					<li><a
						href="${pageContext.request.contextPath}/event/doRetrieve.do">푸조
					</a></li>
					<li><a
						href="${pageContext.request.contextPath}/event/doRetrieve.do">캐딜락
					</a></li>
					<li><a
						href="${pageContext.request.contextPath}/event/doRetrieve.do">링컨
					</a></li>
				</ul>
			</li>
		</ul>
