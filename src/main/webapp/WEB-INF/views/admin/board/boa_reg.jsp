...
<div class="container">
    ...
    <form action="<c:url value='/admin/board/save.do'/>" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" id="nickname" name="nickname"
                   value="${sessionScope.loginUser != null ? sessionScope.loginUser.nickname : '관리자'}" readonly />
        </div>
        ...
        <div class="btn-group">
            ...
            <button type="button" class="btn btn-cancel"
                    onclick="location.href='<c:url value='/admin/board/boa_list.do'/>'">취소</button>
        </div>
    </form>
</div>
