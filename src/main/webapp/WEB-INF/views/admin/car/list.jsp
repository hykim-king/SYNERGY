        ...
        <tbody>
            ...
            <c:forEach var="car" items="${carList}" varStatus="status">
                <tr>
                    ...
                    <td>
                        <form method="post" action="delete.do" style="display:inline;" onsubmit="return confirm('정말 삭제하시겠습니까?');">
                            <input type="hidden" name="carCode" value="${car.carCode}" />
                            <button type="submit" class="action-btn delete">삭제</button>
                        </form>
                        <a href="editView.do?carCode=${car.carCode}" class="action-btn">수정</a>
                    </td>
                </tr>
            </c:forEach>
        </tbody>
